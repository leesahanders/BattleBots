...
<iframe src="tmp.html" width='1000px' height='600px'></iframe>
...
<iframe src="tmp1.html" width='1000px' height='600px'></iframe>
...
# ggplot(robot_wins, aes(wins, Type)) + geom_boxplot()
